...
const Profile = ({tutorData}) => {
    ...
    const addExperience = e => {
        e.preventDefault();
        addItem("experiences", {startingDate:"", endingDate: "", position:"", workPlace: ""});
    }
                    ...
                    <div key={index}>
                        <div>
                            ...
                            <div className='grid grid-cols-2 gap-5 mt-5'>
                                ...
                                <div>
                                    <p className='form__label'>Work Place*</p>
                                    <input type="text" name='workPlace' value={item.workPlace} className='form__input' onChange={e => handleExperienceChange(e, index)} />
                                </div>
                            </div>
