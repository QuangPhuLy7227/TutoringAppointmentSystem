...
const TutorDetails = () => {
  ...
  const {id} = useParams();
  const { data:tutor, loading, error } = useFetchData(`${BASE_URL}/tutors/${id}`);
  const { name, qualifications, experiences, timeSlots, reviews, bio, about, averageRating, totalRating, specialization, photo } = tutor;
          ...
          <div className='md:col-span-2'>
            <div className='flex items-center gap-5'>
              ...
              <div>
                ...
                <p className='text_para text-[14px] leadiing-6 md:text-[15px] lg:max-w-[390px]'>{bio}</p>
              </div>
            </div>
